...
], function(BaseController, JSONModel, Fragment, History, formatter, Filter, FilterOperator) {
	"use strict";

	return BaseController.extend("smud.pm.ZPM_RPDS_INVESTIGATIONS.controller.Worklist", {
		...
		onInit: function() {
			...
			this.addHistoryEntry({
				...
				intent: "#RPDSInvestigations-display"
			}, true);
		},
		...
		_showObject: function(oItem) {
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("Notifid")
			});
		},
